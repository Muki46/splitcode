...
<?php if ( $themify->hide_image != 'yes' ) : ?>
	...
	<?php elseif ( ( ( is_single() && isset( $themify->is_builder_loop ) ) || ! is_single() ) && $post_image = themify_get_image($themify->auto_featured_image . $themify->image_setting . "w=".$themify->width."&h=".$themify->height) ) : ?>
